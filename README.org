...
** Appendici logiche
Per una questione di trasparenza questa è la documentazione del progetto, non sarà molto ma è tanto per un progetto open source:
...
- [[./docs/pag/regole-di-sviluppo.org][Policy di sviluppo]]: Chiarimento sulle politiche di sviluppo e lo scopo del progetto.
- [[./docs/pag/standard.org][Standard sintattico]]: Standard del DSL.
- [[./docs/pag/compilatori.org][Compilatori Lisp compatibili]]: Quale scegliere?
  
Per il resto bug o potenziali problematiche o richieste di nuove funzioni aprire un [[https://github.com/NF02/cl-obelisk/issues][issues]].
** Licenza
